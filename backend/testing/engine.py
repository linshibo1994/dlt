...
class TestEngine:
    ...
    def test_single(
        ...
        result: Dict[str, Any] = {
            ...
            "target_front_balls": target_draw.get("front_balls"),
            "target_back_balls": target_draw.get("back_balls"),
        ...
        for winning in result["winnings"]:
            self._emit(
                "winning",
                {
                    ...
                    "periods": periods,
                    "count": count,
                    "prize_level": winning.get("prize_level"),
                    "prize_name": winning.get("prize_name"),
                    "match_combination": winning.get("match_combination"),
                    "predicted_front": winning.get("predicted_front", []),
                    "predicted_back": winning.get("predicted_back", []),
