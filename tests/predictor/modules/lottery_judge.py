...
class LotteryJudge:
    ...
    def __init__(self):
        ...
        self.prize_conditions = {
            1: [(5, 2)],           # 一等奖：前区5中5 + 后区2中2
            2: [(5, 1)],           # 二等奖：前区5中5 + 后区2中1  
            3: [(5, 0)],           # 三等奖：前区5中5 + 后区2中0
            4: [(4, 2)],           # 四等奖：前区5中4 + 后区2中2
            5: [(4, 1)],           # 五等奖：前区5中4 + 后区2中1
            6: [(4, 0), (3, 2)],   # 六等奖：前区5中4后区2中0 或 前区5中3后区2中2
            7: [(3, 1)],           # 七等奖：前区5中3 + 后区2中1
            8: [(3, 0), (2, 2)],   # 八等奖：前区5中3后区2中0 或 前区5中2后区2中2
            9: [(2, 1), (1, 2), (0, 2)]   # 九等奖：前区5中2后区2中1 或 前区5中1后区2中2 或 前区5中0后区2中2
        }
...
def test_lottery_judge():
    ...
    test_cases = [
        ...
        # 四等奖：4+2
        ("01,02,03,04,05", "01,02", "01,02,03,04,06", "01,02", 4),
        # 五等奖：4+1
        ("01,02,03,04,05", "01,02", "01,02,03,04,06", "01,03", 5),
        # 六等奖：4+0
        ("01,02,03,04,05", "01,02", "01,02,03,04,06", "03,04", 6),
        # 六等奖：3+2
        ("01,02,03,04,05", "01,02", "01,02,03,06,07", "01,02", 6),
        # 七等奖：3+1
        ("01,02,03,04,05", "01,02", "01,02,03,06,07", "01,03", 7),
        # 八等奖：3+0
        ("01,02,03,04,05", "01,02", "01,02,03,06,07", "03,04", 8),
        # 八等奖：2+2
        ("01,02,03,04,05", "01,02", "01,02,06,07,08", "01,02", 8),
        # 九等奖：2+1
        ("01,02,03,04,05", "01,02", "01,02,06,07,08", "01,03", 9),
        # 九等奖：1+2
        ("01,02,03,04,05", "01,02", "01,06,07,08,09", "01,02", 9),
        # 九等奖：0+2
        ("01,02,03,04,05", "01,02", "06,07,08,09,10", "01,02", 9),
        # 未中奖
